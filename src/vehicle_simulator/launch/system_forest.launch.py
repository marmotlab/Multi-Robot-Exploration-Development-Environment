...
def generate_launch_description():
    ...
    declare_vehicleX_list = DeclareLaunchArgument('vehicleX_list', default_value='[0.0, 5.0]', description='')
    declare_vehicleY_list = DeclareLaunchArgument('vehicleY_list', default_value='[0.0, -5.0]', description='')
