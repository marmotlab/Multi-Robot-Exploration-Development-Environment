...
def generate_robot_groups(context, *args, ** kwargs):
    ...
    for i in range(n):
        ...
        robot_groups.append(TimerAction(period=float(i), actions=[group]))
    return robot_groups
...
def generate_launch_description():
    ...
    declare_world_name = DeclareLaunchArgument('world_name', default_value='no_roof_big_warehouse5', description='')
    ...
    # declare_vehicleX_list = DeclareLaunchArgument('vehicleX_list', default_value='[-20.43, -30.78, 11.25, -10.17, 22.93]', description='')
    # declare_vehicleY_list = DeclareLaunchArgument('vehicleY_list', default_value='[8.46, 13.13, -14.49, -17.77, 24.30]', description='')
    declare_vehicleX_list = DeclareLaunchArgument('vehicleX_list', default_value='[-0.22, 30.94, -26.18, 20.97, -18.93, 5.50]', description='') 
    declare_vehicleY_list = DeclareLaunchArgument('vehicleY_list', default_value='[-0.49, -12.61, -16.35, 17.07, -24.02, 24.60]', description='')
    ...
    declare_n_robots = DeclareLaunchArgument('n_robots', default_value='3')
    ...
    # static_map_trans = Node(
    #     package='tf2_ros',
    #     executable='static_transform_publisher',
    #     name='globalmapTransPublisher',
    #     # x y z yaw pitch roll frame_id child_frame_id
    #     arguments=['0', '0', '0', '0', '0', '0', 'map', 'robot_0/map']
    # )

    # static_robot0_robot1_trans = Node(
    #     package='tf2_ros',
    #     executable='static_transform_publisher',
    #     name='vehicleTransPublisher',
    #     # x y z yaw pitch roll frame_id child_frame_id
    #     arguments=['2', '0', '0', '0', '0', '0', 'robot_0/map', 'robot_1/map']
    # )
    ...
    # ld.add_action(static_map_trans)
    # ld.add_action(static_robot0_robot1_trans)
