...
def generate_robot_groups(context, *args, ** kwargs):
    ...
    for i in range(n):
        ...
        robot_groups.append(TimerAction(period=float(2 * i), actions=[group]))
    return robot_groups
...
def generate_launch_description():
    ...
    declare_world_name = DeclareLaunchArgument('world_name', default_value='warehouse', description='')
    ...
    declare_n_robots = DeclareLaunchArgument('n_robots', default_value='4') 
