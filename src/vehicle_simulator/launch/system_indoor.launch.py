...
def generate_launch_description():
    ...
    declare_vehicleX_list = DeclareLaunchArgument('vehicleX_list', default_value='[0.0, 23.01, 32.06, 62.49]', description='')
    declare_vehicleY_list = DeclareLaunchArgument('vehicleY_list', default_value='[0.0, 11.62, -6.57, 9.30]', description='')
