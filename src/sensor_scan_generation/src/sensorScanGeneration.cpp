                                  ...
                                  const std::string& ns_prefix)
{
  ...
  odometryIn.child_frame_id = ns_prefix + "sensor_at_scan";
  ...
  transformTfGeom.child_frame_id = ns_prefix + "sensor_at_scan";
  ...
  scan_data.header.frame_id = ns_prefix + "sensor_at_scan";
...
int main(int argc, char** argv)
{
  ...
  // sync_->registerCallback([ns_prefix](nav_msgs::msg::Odometry::ConstSharedPtr odometry, sensor_msgs::msg::PointCloud2::ConstSharedPtr laserCloud2){
  //   laserCloudAndOdometryHandler(odometry, laserCloud2, ns_prefix);
  // });
  sync_->registerCallback(std::bind(laserCloudAndOdometryHandler, placeholders::_1, placeholders::_2, ns_prefix));
